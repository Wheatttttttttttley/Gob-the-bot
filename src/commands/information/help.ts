...
const run = async (interaction: CommandInteraction) => {
    ...
    case 'flip':
        ...
        break;
    case 'rps':
        embed.setDescription('`/rps [rock|paper|scissors]` - Play rock paper scissors.')
            .addField('GOALS 🎯', 'Play rock paper scissors and see who wins.')
            .addField('PAYOUT 💰', 'win: **1x**\ndraw: *you get your bet back*');
        break;
    case 'highlow':
        embed.setDescription('`/highlow [low|high]` - Play high low.')
            .addField('GOALS 🎯', 'Play high low and see if the number is low[1-5] or high[6-10]')
            .addField('PAYOUT 💰', 'win: **1x**');
        break;
    case 'dice':
        embed.setDescription('`/dice [1-6]` - Roll a dice.')
            .addField('GOALS 🎯', 'Roll a dice and see if you get the number.')
            .addField('PAYOUT 💰', 'win: **5x**');
        break;
    case 'roulette':
        embed.setDescription('`/roulette [type]` - Play roulette.')
            .addField('GOALS 🎯', 'Place a bet. Roll the wheel and see if you win.')
            .addField('TYPES 🎲', '**Straight Up** : Place a bet on a number between 1-36.\n' +
            ...
            .addField('COLORS 🎨', '🔴 Red: 1, 3, 5, 7, 9, 12, 14, 16, 18, 19, 21, 23, 25, 27, 30, 32, 34, 36\n' +
